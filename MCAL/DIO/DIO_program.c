...
DIO_ErrorStatus DIO_enumSetPinDirectoin (u8 Copy_u8PORT, u8 Copy_u8PIN, u8 Copy_u8Direction)
{
	...
	if((Copy_u8Direction <= DIO_PORTD) && (Copy_u8PIN <= DIO_PIN7))
	{
...
DIO_ErrorStatus DIO_enumSetPinValue     (u8 Copy_u8PORT, u8 Copy_u8PIN, u8 Copy_u8Value)
{
	...
	if((Copy_u8Value <= DIO_PORTD) && (Copy_u8Value <= DIO_PIN7))
	{
...
DIO_ErrorStatus DIO_enumGetPinValue     (u8 Copy_u8PORT, u8 Copy_u8PIN, u8 *Copy_PtrData)
{
	...
	{
		switch (Copy_u8PORT) {
						case DIO_PORTA: *Copy_PtrData = GET_BIT(PINA, Copy_u8PIN);
							break;
						case DIO_PORTB: *Copy_PtrData = GET_BIT(PINB, Copy_u8PIN);
							break;
						case DIO_PORTC: *Copy_PtrData = GET_BIT(PINC, Copy_u8PIN);
							break;
						case DIO_PORTD: *Copy_PtrData = GET_BIT(PIND, Copy_u8PIN);
							break;
						default:
							break;
						}
